...
resourcestring
  ...
  SSessionExpiredMsg = 'Указанный сеанс истек из-за неактивности или был неверным идентификатором сеанса';
  ...
  SServerMethodMissing = 'Метод не найден в списке методов сервера';
  ...
  SAuthorizationFail = '%s неверная авторизация для данного запроса.';
  SAuthSessionFail = 'У текущего сеанса нет разрешения на выполнение запрошенного действия.';
